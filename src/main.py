...
if __name__ == '__main__':
    ...
    parser.add_argument('--beam_candidate', type=int, default=1000,
                        help="maximum number of frontiers to search in each iteration")
    parser.add_argument('--stabilize_candidate', type=int, default=64,
                        help="maximum number of neurons to stabilize in each iteration")
